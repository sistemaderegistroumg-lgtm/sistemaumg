...
require_once 'enviar_credenciales.php';
include 'mascota.php';
requireSession(1);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['registrar'])) {
   ...
   $password = generarPasswordSegura();
    ...
    if (
        ...
        !in_array($rol_id, $rolesPermitidos)
    ) {
...
enviarCredenciales(
    ...
    $nombreRol
            ...
            $mensaje = 'Usuario registrado exitosamente, su usuario y contraseña llegaran a su correo.';
            $tipo    = 'success';
        }
    }
}
...
<nav>
    ...
    <span style="color:rgba(255,255,255,.7);font-size:.875rem">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge <?= $u['nombre_rol'] === 'Administrador' ? 'admin' : 'cat' ?>">
...
function confirmarEliminar(id, nombre) {
    ...
    if (
        ...
        window.location.href =
            'gestionar_usuarios.php?delete=' + id;
    }
}
