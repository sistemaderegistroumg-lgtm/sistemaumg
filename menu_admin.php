...
<head>
    ...
    <style>
        ...
        * {
        ...
        .card.green .card-link  { background:#16a34a; }
        .card.green .card-link:hover { background:#166534; }

        .card.purple .card-link { background:#7c3aed; }
        .card.purple .card-link:hover { background:#5b21b6; }

        .card.orange .card-link { background:#ea580c; }
        .card.orange .card-link:hover { background:#9a3412; }

        .card.teal .card-link { background:#0d9488; }
        .card.teal .card-link:hover { background:#115e59; }
...
<div class="container">
  ...
  <div class="cards-grid">
    ...
    <p>Valida si un carnet o certificado fue emitido por la Universidad Mariano Gálvez .</p>
...
<div class="card purple">
    ...
    <p>
        Registro automático de asistencia mediante reconocimiento facial
        usando Face-API y validación biométrica en tiempo real.
    </p>
...
<div class="card green">
    ...
    <p>
        Permite a los catedráticos validar y confirmar oficialmente
        la asistencia detectada mediante reconocimiento facial.
    </p>
...
<div class="card teal">
    ...
    <p>
        Visualiza estadísticas en tiempo real, historial de ingresos,
        asistencia por salón, reportes por fecha y árboles de registros
        biométricos del sistema.
    </p>
